...
TEST(FunctionTest, ConcatWsStr)
{
    ...
    // both inputs null => empty string (not null)
...
TEST(FunctionTest, ConcatWs3Str)
{
    ...
    // Spark: concat_ws("-", "", null, null) => "" (empty string)
    ...
    // Spark: concat_ws("-", null, null, null) => "" (empty string)
